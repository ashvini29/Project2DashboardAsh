# -*- coding: utf-8 -*-
"""
Created on Wed Dec 16 19:17:44 2020
...
dataframe = pd.read_csv("C:/Test/capture/Results/unused.csv")
...
app.layout = html.Div([
    ...
    html.Div([html.H4('Number of rows to display:'),
              ...
              html.H4('Select RP to display:'),
              dcc.Checklist(options=[{'label': 'RP1', 'value': 'Apples'},
